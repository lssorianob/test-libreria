...
public class Login extends javax.swing.JFrame {
    ...
    public static String perfil = ""; //Se declara así para enviar datos entre interfaces
    String pass = "";
    ...
    public Login() {
        ...
        ImageIcon wallapper_logo = new ImageIcon("src/images/utiles2.png"); //Logo de la empresa
    ...
    /**Esto se hace para cambiar el icono de la interfaz */
    @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 0, 270, 330));
        ...
        jLabel_Footer.setText("Creado por Infinito Software ®");
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 500, 180, -1));
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 410, 530));
        ...
        if (!user.equals("") || !pass.equals("")) {
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                    "select usu_cargo, usu_estado from usuario where usu_nombre = '" + user
                    + "' and usu_clave = '" + pass + "'");

                ResultSet rs = pst.executeQuery();
                if (rs.next()) {

                    String tipo_nivel = rs.getString("usu_cargo");
                    perfil = tipo_nivel; 
                    String estatus = rs.getString("usu_estado");

                    if (tipo_nivel.equalsIgnoreCase("Administrador") && estatus.equalsIgnoreCase("1")) {
                        //dispose(); Hace que el JFrame sea destruido y limpiado por el sistema operativo.
                        dispose();
                        new Administrador().setVisible(true);
                    } else if (tipo_nivel.equalsIgnoreCase("Gerente") && estatus.equalsIgnoreCase("1")) {
                        dispose();
                        new Gerente().setVisible(true);
                    } else if (tipo_nivel.equalsIgnoreCase("Usuario") && estatus.equalsIgnoreCase("1")) {
                        dispose();
                    ...
                    //Limpia los campos de la interfaz donde uno es incorrecto o los dos
                    txt_user.setText("");
                    txt_password.setText("");
                }

            } catch (SQLException e) {
                System.err.println("Error en el botón Acceder." + e);//Este error lo tira en rojo
