 ...
 * @author USUARIO
 */
public class UsuarioU extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonArticulos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 170, 130));
        ...
        getContentPane().add(jButtonClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 130, 170, 130));
        ...
        getContentPane().add(jButtonVentaCaja, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, 170, 130));
        ...
        getContentPane().add(jButtonReportes, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 330, 170, 130));

        jLabelUsuario.setFont(new java.awt.Font("Perkeo", 1, 18)); // NOI18N
        jLabelUsuario.setForeground(new java.awt.Color(51, 153, 255));
        jLabelUsuario.setText("Usuario:");
        getContentPane().add(jLabelUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 60, 40));
        ...
        getContentPane().add(jLabelPerfil, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 60, 40));
        ...
        getContentPane().add(jLabelLibreria, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, 130, 40));

        jLabelFecha.setFont(new java.awt.Font("Perkeo", 1, 18)); // NOI18N
        jLabelFecha.setForeground(new java.awt.Color(51, 153, 255));
        jLabelFecha.setText("Fecha:");
        getContentPane().add(jLabelFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 0, 50, 40));
        ...
        getContentPane().add(jButtonSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 490, 100, 100));
        ...
        getContentPane().add(jLabelArticulos1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 110, 80, 20));
        ...
        getContentPane().add(jLabelArticulos2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 110, 20));
        ...
        getContentPane().add(jLabelArticulos6, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 310, 110, 20));
        ...
        getContentPane().add(jLabelArticulos7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, 80, 20));

        jLabelUsuario1.setFont(new java.awt.Font("Perkeo", 1, 18)); // NOI18N
        jLabelUsuario1.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jLabelUsuario1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, 80, 40));

        jLabelFecha1.setFont(new java.awt.Font("Perkeo", 1, 18)); // NOI18N
        jLabelFecha1.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jLabelFecha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 0, 70, 40));

        jLabelPerfil1.setFont(new java.awt.Font("Perkeo", 1, 18)); // NOI18N
        jLabelPerfil1.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jLabelPerfil1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, 110, 40));

        jLabelLibreria1.setFont(new java.awt.Font("Perkeo", 1, 18)); // NOI18N
        jLabelLibreria1.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jLabelLibreria1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 0, 150, 40));
        getContentPane().add(jLabelFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 640));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuarioU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
